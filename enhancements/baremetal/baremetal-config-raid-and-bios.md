...
In order to make it easy for users to set the RAID and BIOS configuration for BMH, as the
setting of RAID and BIOS for servers is a common need.
...
As a user, I want to config the raid and bios of BMH in the IPI process.
